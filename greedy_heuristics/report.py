...
if __name__ == '__main__':
    ...
    print(test_algorithm(kroa100_distance_matrix, kroa100_instance, double_greedy_cycle))
    ...
    print(test_algorithm(krob100_distance_matrix, krob100_instance, double_greedy_cycle))
